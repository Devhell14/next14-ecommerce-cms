      ...
      <div className="container mx-auto flex justify-between items-center">
        <Link href="/" className="hover:text-current">
          <h1 className="text-[26px]">
            <span className="text-accent">E</span>VBIKE
          </h1>
        </Link>
        <div className="flex items-center gap-[26px]">
          ...
          <div onClick={() => handleCartClick()} className="relative cursor-pointer">
            ...
            <div className="bg-accent w-[18px] h-[18px] absolute -right-1 -bottom-1 rounded-full text-white flex item-center justify-center text-sm font-medium ">
              {cartCount}
            </div>
          </div>
        </div>
